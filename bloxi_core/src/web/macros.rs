// Implements *Actor* Message traits for a given message type and its response type
...
// Implements Actix *Web* HTTP Responder for a simple type that can be turned into JSON
